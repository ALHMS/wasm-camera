...
function findWasmBinary() {
  return locateFile('processor_v2.wasm');
}
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['processImage'] != 'undefined', 'missing Wasm export: processImage');
  ...
  _processImage = Module['_processImage'] = createExportWrapper('processImage', 10);
